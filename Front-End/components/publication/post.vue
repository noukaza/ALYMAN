          ...
          <vs-card actionable class="cardx border border-dark">
            ...
            <div slot="footer">
              <vs-row vs-justify="flex-end">
                ...
                <vs-button class="m-1" color="danger" type="gradient" v-on:click='dislike' icon="thumb_down">
                </vs-button>
                ...
                <vs-button @click="popupActivo2=true"  color="#3dd495" gradient-color-secondary="rgb(130, 207, 23)" class="m-1"  v-if="image.user._id === $auth.user._id" icon="edit" type="filled"></vs-button>
                ...
                <vs-button color="dark" color-text="rgb(50,50,50)" icon="delete_forever" type="gradient" class="m-1"
                  v-if="image.user._id === $auth.user._id" v-on:click='deleteImage'></vs-button>
              </vs-row>
            </div>
          </vs-card>
        </vs-col>
