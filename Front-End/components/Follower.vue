      ...
      <li v-for="(dataFollower,index) in dataFollowers">
        <b-row >
          <b-col v-on:click="redirect(index)" v-if="type === 'followers'">
              <b-img rounded="circle" alt="Circle image" v-bind:src= "'http://41584f23.ngrok.io/'+dataFollower.following.profileImage" style = "width : 100% ; heitgh : 100%"></b-img>
          </b-col>
          <b-col v-on:click="redirect(index)" v-else>
              <b-img rounded="circle" alt="Circle image" v-bind:src= "'http://41584f23.ngrok.io/'+dataFollower.follower.profileImage" style = "width : 100% ; heitgh : 100%"></b-img>
          </b-col>
